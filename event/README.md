...
3. **Wall observations.** Fact: a physical clock reading. Owner: port (raw observation); chronology consumes it after admission. Operation: pure chronology admission. Carrier: the wall-observation port contract. Refusal: a raw observation is never an AcceptedHlc. Chronology: carries the settled clock-role table.
